...
const VisionSection = () => {
  return (
    <section className="py-20 md:py-28 relative bg-deepbrown text-white overflow-hidden">
      {/* Background Image with Overlay */}
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-deepbrown/80 z-10"></div>
        <img 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="heading-lg text-white mb-6">
              <span className="border-b-2 border-gold pb-2">Dari Ladang NTT</span> ke Dapur Dunia: Visi Global Kami
            </h2>
            
            <p className="text-white/80 mb-6 paragraph">
            ...
            <p className="text-white/80 paragraph">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="bg-white/10 backdrop-blur-sm p-5 rounded-lg border border-white/20">
                  <div className="font-playfair font-bold text-4xl text-gold mb-2">80+</div>
                  <div className="text-white/80">Petani Mitra</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm p-5 rounded-lg border border-white/20">
                  <div className="font-playfair font-bold text-4xl text-gold mb-2">3</div>
                  <div className="text-white/80">Provinsi</div>
                </div>
              </div>
              <div className="space-y-4 mt-6">
                <div className="bg-white/10 backdrop-blur-sm p-5 rounded-lg border border-white/20">
                  <div className="font-playfair font-bold text-4xl text-gold mb-2">12+</div>
                  <div className="text-white/80">Tahun Pengalaman</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm p-5 rounded-lg border border-white/20">
                  <div className="font-playfair font-bold text-4xl text-gold mb-2">5+</div>
                  <div className="text-white/80">Negara Tujuan</div>
                </div>
              </div>
            </div>
          </div>
